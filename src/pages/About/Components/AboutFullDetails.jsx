              ...
              <Row>
                ...
                <Col lg={7} md={8} sm={12}>
                  <div className="para-wrap-about">
                    <p>
                      About My name is Ben Perham and | am the Founder of
                      Oxygens - weicome! 1 left university with a First-Class
                      ...
                      sues that medications ould not help with__n essence
