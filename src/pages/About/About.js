    ...
    <div>
              ...
              >
                ...
                <div className="about__list mb-35">
                  <ul>
                    ...
                    <li className="d-flex align-items-center">
                      {" "}
                      <i className="icon_check"></i> Access more then 100K
                      online courses
                    </li>
                    <li className="d-flex align-items-center">
                      {" "}
      ...
      <section className="counter__area pt-145 pb-100">
        <div className="container">
          ...
          <div className="row">
            <div className="col-xxl-2 offset-xxl-1 col-xl-2 offset-xl-1 col-lg-3 col-md-3 offset-md-0 col-sm-5 offset-sm-2">
            ...
            <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-5">
              <div className="counter__item counter__pl-80 mb-30">
                <div className="counter__icon book mb-15">
            ...
            <div className="col-xxl-2 offset-xxl-0 col-xl-3 offset-xl-0 col-lg-3 offset-lg-0 col-md-3 offset-md-0 col-sm-5 offset-sm-2">
              <div className="counter__item counter__pl-34 mb-30">
                <div className="counter__icon graduate mb-15">
                  <svg viewBox="0 0 512 512">
                    <g id="Page-1">
                      <g id="_x30_01---Degree">
                        <path
            ...
            <div className="col-xxl-2 offset-xxl-1 col-xl-3 col-lg-3 col-md-3 col-sm-5">
              <div className="counter__item mb-30">
                <div className="counter__icon globe mb-15">
                  <svg viewBox="0 0 512 512">
                    <path
                      className="st0"
