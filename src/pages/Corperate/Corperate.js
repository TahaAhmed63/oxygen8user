              ...
              <Col lg={7} xl={7} xxl={7} md={8} sm={12}>
                <div className="para-wrap-about mt-0">
                  ...
                  <p className="para-wrap-about-para">
                    ...
                    manage and recover from these intense and unsustainable
                    states.
                    <br />
                  </p>
                  <br />
                  <p className="para-wrap-about-para">
                    Based upon my experiences in industry, and my personal
                    recovery from stress-related illnesses, I have curated
                    workshops and presentations that can be tailored to meet the
                    ...
                    equips individuals with the necessary tools and information
                    to develop an arsenal of self-regulating techniques for
                    effectively managing stress levels or supporting burnout
                    recovery. These methods can be discreetly incorporated into
                    the workday and can be adapted to suit employees any time
                    and anywhere. <br />
                  </p>
                  <br />
                  <p className="para-wrap-about-para">
                    {" "}
                    The techniques employ biofeedback, utilising CNSF and
                    Optimisation, to empower your employees with tools for
                    resilience and control over stress. By enhancing their
                    resilience, we not only contribute to their improved health
                    and well-being, but also foster increased, sustainable
