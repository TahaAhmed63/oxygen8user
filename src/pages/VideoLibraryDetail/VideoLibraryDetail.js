                  ...
                  <div className="page__title-breadcrumb">                            
                      <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                          ...
                          <li className="breadcrumb-item"><Link to='/videolibrarydetail'>Video Library</Link></li>
                          <li className="breadcrumb-item active" aria-current="page" >The business Intelligence analyst Video Library 2022</li>
                        </ol>
                      </nav>
                  </div>
                  <span className="page__title-pre">Development</span>
                  <h5 className="page__title-3" style={{textAlign:'left'}}>The business Intelligence analyst Course 2022</h5>
               </div>
               ...
               <div className="course__sidebar-widget-2 white-bg mb-20">
                  <div className="course__video">
                     ...
                     <div className="course__enroll-btn">
                        <a href="contact.html" className="e-btn e-btn-7 w-100" style={{background:'#337c75'}}>Enroll <i className="far fa-arrow-right"></i></a>
                     </div>
                  </div>
               </div>
