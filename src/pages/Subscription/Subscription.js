                        ...
                        <div className="tab-content" id="courseTabContent">
                           <div className="tab-pane fade show active" id="grid" role="tabpanel" aria-labelledby="grid-tab">
                              ...
                              {subscription?.map(item=>
                                 // <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 grid-item cat1 cat2 cat4 subCard" stye>
                                 
                                 //   <h3 className="subCard-text">{item?.name}</h3>
                                 //   <h4 className="subCard-price">${item?.price}</h4>
                                 //   <p>for {item?.duration} {item?.period}</p><br/>
                                 //   <p className="subCard-detail">{item?.description}</p>
                                 //   <StripeCheckout
                                 //      token={(token)=>{onToken(token,item)}}
                                 ...
                                 //    >
                                 //       <button type='submit' style={{color:"#337c75",marginTop:'30px',marginBottom:'10px',backgroundColor:'#fff',border:'none',fontWeight:'bold',borderRadius:'50px',paddingInline:'40px',paddingTop:'10px',paddingBottom:'10px'}} > {loading === true ? (
                                 //          <ColorRing
                                 //            visible={true}
                                 //            height="40"
                                 //            width="40"
                               ...
                               >
                                 ...
                                 <h3 className="subCard-text">{item?.name}</h3>
                                    <h4 className="subCard-price"><sub>$</sub>{item?.price}</h4>
                                    <p>for {item?.duration} {item?.period}</p><br/>
                                    <p className="subCard-detail">{item?.description}</p>
                                    <StripeCheckout
                                      token={(token)=>{onToken(token,item)}}
                                      ...
                                      amount={item?.price * 100}
                                    >
                                       <button type='submit' style={{color:"#fff",backgroundColor:'#74b3ac',width:'80%',textAlign:'center',marginTop:'30px',marginBottom:'10px',borderStyle:'solid',borderColor:'#fff',fontWeight:'bold',borderRadius:'50px',paddingInline:'50px',paddingTop:'10px',paddingBottom:'10px',fontSize:'1rem'}} > {loading === true ? (
                                          <ColorRing
                                            visible={true}
                                            height="40"
                                            width="40"
                                            ariaLabel="blocks-loading"ss
                                            wrapperStyle={{}}
                                            wrapperClass="blocks-wrapper"
                                            colors={[
                                              "#fff",
